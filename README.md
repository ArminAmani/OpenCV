# OpenCV
In this tutorial We learn how to work with the basics of OpenCV using python. Lets get Started.

# Installation

You first need to have python installed on our computer. If you do this we can get started. 
